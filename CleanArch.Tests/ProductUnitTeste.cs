...
namespace CleanArch.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
        {
            ...
            action.Should().Throw<CleanArch.Domain.Validations.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "P", "Product Description", 9.99m, 99,
                "product image");
            action.Should().Throw<CleanArch.Domain.Validations.DomainExceptionValidation>()
                 .WithMessage("Invalid name, too short, minimum 2 characters");
        }
        ...
        public void CreateProduct_WithNullImageName_NoDomainException()
        {
            ...
            action.Should().NotThrow<CleanArch.Domain.Validations.DomainExceptionValidation>();
        }
